...
/* TODO: Create a placeholder variable for the mainimage section - the SCP firmware will be copied into this section
...
/* TODO: ADO: Update program counter to point to ITCM and start executing the SCP firmware
*  ADO: https://azurecsi.visualstudio.com/Dev/_workitems/edit/1484340
*/
