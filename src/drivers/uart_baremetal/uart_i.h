...
/*----------- Nested includes ------------*/
// @TODO - Can we get these from the silicon libs repo?
//       - https://azurecsi.visualstudio.com/DuvallFw/_workitems/edit/1448748

/*****************************************************************************/
/*  UART0 Control Register Locations                                          */
/*****************************************************************************/
#define UART0_DR   *((volatile unsigned*)uart_base_addr)
#define UART0_RSR  *((volatile unsigned*)(uart_base_addr + 0x04))
#define UART0_ECR  *((volatile unsigned*)(uart_base_addr + 0x04))
#define UART0_LCRH *((volatile unsigned*)(uart_base_addr + 0x2C))
#define UART0_LCRM *((volatile unsigned*)(uart_base_addr + 0x28))
#define UART0_LCRL *((volatile unsigned*)(uart_base_addr + 0x24))
#define UART0_CR   *((volatile unsigned*)(uart_base_addr + 0x30))
#define UART0_FR   *((volatile unsigned*)(uart_base_addr + 0x18))
#define UART0_IIR  *((volatile unsigned*)(uart_base_addr + 0x1C))
#define UART0_ICR  *((volatile unsigned*)(uart_base_addr + 0x44))
