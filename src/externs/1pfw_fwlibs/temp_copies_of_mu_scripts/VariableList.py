...
class StringFormatOptions:
    ...
    # This option only applies with c_format is true.
    # When true, do not mangle the c_format name for uniqueness
    # When false, allow mangling for the c_format for uniqueness
    c_no_mangle = False
