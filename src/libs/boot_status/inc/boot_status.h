...
typedef enum _mscp_boot_status_codes_t
{
    ...
    MSCP_BOOT_STATUS_CODE_SCP_DDR_INIT_START,
    MSCP_BOOT_STATUS_CODE_SCP_DDR_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_SPI_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_D2DMBX_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_PRE_GTIMER_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_CFGMGR_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_CFGMGR_OVERRIDE_CHECK_END,
    MSCP_BOOT_STATUS_CODE_SCP_CFGMGR_OVERRIDE_APPLY_END,
    MSCP_BOOT_STATUS_CODE_SCP_UART_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_STDIO_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_POST_GTIMER_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_PRE_CSS_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_GPIO_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_CD_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_PRE_FUSE_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_D2DCNTR_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_POST_CSS_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_VAB_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_SHARED_MEM_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_D2D_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_POST_FUSE_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_COREINFO_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_HW_SEM_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_VIRT_IRQ_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_PEX_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_HM_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_APCORE_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_SOS_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_SDM_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_CDED_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_MCSP2MSCP_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_WS_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_POWER_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_RAS_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_ETC_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_ETD_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_MTS_INIT_START,
    MSCP_BOOT_STATUS_CODE_SCP_MTS_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_IB_TELM_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_MSCP_APRT_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_MSCP_APS_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_MSCP_APNS_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_MSCP_TFA_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_MSCP_IOSS_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_MSCP_PCIE_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_POWER_TLM_SCP_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_POWER_TLM_CORE_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_POWER_SCMI_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_RTOSMON_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_SEL_INIT_START,
    MSCP_BOOT_STATUS_CODE_SCP_SEL_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_UTC_SYNC_INIT_START,
    MSCP_BOOT_STATUS_CODE_SCP_UTC_SYNC_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_WD_INIT_END,
    MSCP_BOOT_STATUS_CODE_SCP_SENSOR_FIFO_START,
    MSCP_BOOT_STATUS_CODE_SCP_SENSOR_FIFO_END,
    // Boot status after runtime init
    MSCP_BOOT_STATUS_CODE_SOS_PCIE_PHY_END,
    MSCP_BOOT_STATUS_CODE_SOS_MSCP_MANIFEST_END,
    MSCP_BOOT_STATUS_CODE_SOS_STARTUP_ACCEL_MANIFEST_END,
    MSCP_BOOT_STATUS_CODE_SOS_MCP_END,
    MSCP_BOOT_STATUS_CODE_SOS_SDM_ITCM_END,
    MSCP_BOOT_STATUS_CODE_SOS_SDM_DTCM_END,
    MSCP_BOOT_STATUS_CODE_SOS_CDED_ITCM_END,
    MSCP_BOOT_STATUS_CODE_SOS_CDED_DTCM_END,
    MSCP_BOOT_STATUS_CODE_SOS_CLUSTER_CORE_END,
    MSCP_BOOT_STATUS_CODE_SOS_AP_SOC_POWER_END,
    MSCP_BOOT_STATUS_CODE_SOS_AP_SOC_POWER_POST_SYNC_END,
    MSCP_BOOT_STATUS_CODE_SOS_AP_SOC_POWER_POST_SCF_SYNC_END,
    MSCP_BOOT_STATUS_CODE_SOS_BL31_END,
    MSCP_BOOT_STATUS_CODE_SOS_STMM_END,
    MSCP_BOOT_STATUS_CODE_SOS_BL33_END,
    MSCP_BOOT_STATUS_CODE_SOS_HAFNIUM_END,
    MSCP_BOOT_STATUS_CODE_SOS_RMM_END,
    MSCP_BOOT_STATUS_CODE_SOS_RP_DATA_END,
    MSCP_BOOT_STATUS_CODE_SOS_RP_EXE_END,
    MSCP_BOOT_STATUS_CODE_SOS_DIE_CFG_END,
    MSCP_BOOT_STATUS_CODE_SOS_PCIE_LTSSM_END,
    MSCP_BOOT_STATUS_CODE_SOS_SDM_BOOT_END,
    MSCP_BOOT_STATUS_CODE_SOS_CDED_BOOT_END,
    MSCP_BOOT_STATUS_CODE_SOS_PRIMARY_APCORE_BOOT_END,

    //! DDR detailed progress codes for SCP
    ...
    //! Error codes for SCP
    MSCP_BOOT_STATUS_CODE_SCP_E_SPI_BRIDGE_CONFIG,
    MSCP_BOOT_STATUS_CODE_SCP_E_SPI_CTRL_CONFIG,
    ...
    MSCP_BOOT_STATUS_CODE_MCP_VARSVC_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_CFGMGR_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_SPI_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_D2DMBX_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_PRE_GTIMER_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_POST_GTIMER_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_PRE_CSS_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_POST_CSS_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_GPIO_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_PRE_FUSE_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_POST_FUSE_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_D2DCNTR_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_MESH_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_UART_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_STDIO_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_CD_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_VAB_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_SHARED_MEM_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_D2D_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_COREINFO_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_HW_SEM_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_VIRT_IRQ_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_PEX_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_HM_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_APCORE_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_SOS_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_WS_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_POWER_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_RAS_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_ETC_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_ETD_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_IB_TELM_INIT_END,
    ...
    MSCP_BOOT_STATUS_CODE_MCP_MSCP_IOSS_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_MSCP_PCIE_INIT_END,
    ...
    MSCP_BOOT_STATUS_CODE_MCP_RTOSMON_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_SDM_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_CDED_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_MCSP2MSCP_MHU_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_DDR_INIT_START,
    MSCP_BOOT_STATUS_CODE_MCP_DDR_INIT_END,
    ...
    MSCP_BOOT_STATUS_CODE_MCP_MTS_INIT_START,
    MSCP_BOOT_STATUS_CODE_MCP_MTS_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_SENSOR_FIFO_START,
    MSCP_BOOT_STATUS_CODE_MCP_SENSOR_FIFO_END,
    MSCP_BOOT_STATUS_CODE_MCP_SEL_INIT_START,
    MSCP_BOOT_STATUS_CODE_MCP_SEL_INIT_END,
    MSCP_BOOT_STATUS_CODE_MCP_UTC_SYNC_INIT_START,
    MSCP_BOOT_STATUS_CODE_MCP_UTC_SYNC_INIT_END,
    //! Keep last for MCP
