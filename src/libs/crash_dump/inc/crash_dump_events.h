...
typedef enum
{
    ...
    CRASH_DUMP_ET_TYPE_ICC_ICC_CONTEXT_ALREADY_SET,
    CRASH_DUMP_ET_TYPE_ICC_INVALID_CRASHDUMP_CONTEXT,
    CRASH_DUMP_ET_TYPE_ICC_SEND_LARGE_FIFO_CD_MSG_ERROR,
    CRASH_DUMP_ET_TYPE_ICC_SEND_LARGE_REMOTE_CORE_CD_MSG_ERROR,
    CRASH_DUMP_ET_TYPE_ICC_MHU_SEND_CD_SYNC_LOCAL_ERROR,
    CRASH_DUMP_ET_TYPE_ICC_MHU_SEND_CD_SYNC_REMOTE_ERROR,
    CRASH_DUMP_ET_TYPE_HSP_CMD_ASYNC_ERROR,
    CRASH_DUMP_ET_TYPE_HSP_CMD_SYNC_ERROR,
    CRASH_DUMP_ET_TYPE_INIT_INVALID_ADDRESS,
    CRASH_DUMP_ET_TYPE_INIT_INVALID_CRASHDUMP_CONTEXT,
    ...
    CRASH_DUMP_ET_TYPE_EXTERNAL_BUGCHECK,
