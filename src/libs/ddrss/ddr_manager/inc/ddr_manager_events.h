...
typedef enum
{
    ...
    DDR_MANAGER_ET_TYPE_QUEUE_SEND_ERROR_START_POLLING_TIMER,
    ...
    DDR_MANAGER_ET_TYPE_QUEUE_SEND_ERROR_START_RH_TLM_SERVICE,
    DDR_MANAGER_ET_TYPE_SDL_NOT_FOUND,
    DDR_MANAGER_ET_TYPE_SDL_CREATED_EMPTY_SDL_HEADER,
    DDR_MANAGER_ET_TYPE_SDL_FOUND_AND_LOADED_TO_DDR,
    DDR_MANAGER_ET_TYPE_SDL_SKIPPED_CFG_KNOB_DISABLED,
    DDR_MANAGER_ET_TYPE_SDL_COPY_TO_DDR_FAILED,
    DDR_MANAGER_ET_TYPE_SDL_ADDRESS_PUBLISHING_SKIPPED,
    DDR_MANAGER_ET_TYPE_WARM_START_DETECTED,
    DDR_MANAGER_ET_TYPE_DDR_INIT_DURATION_MS,
    DDR_MANAGER_ET_TYPE_DDR_TRAINING_TIME_MS,
    DDR_MANAGER_ET_TYPE_DFWK_DISPATCH_REQUEST,
    DDR_MANAGER_ET_TYPE_SDL_STORE_FAILED,
    DDR_MANAGER_ET_TYPE_SDL_STORED_TO_FLASH,
