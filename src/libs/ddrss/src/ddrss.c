...
void prod_ddrss_lib_init(KNG_DIE_ID die_num)
{
    ...
    ddrss_isr_params_t params = {.die_id = die_num, .ddrss_num = 0};
    ...
    const int FIRST_DDRSS_INT = HW_INT_DDRSS0_COMBINED_SCP_INT;
    const int LAST_DDRSS_INT = HW_INT_DDRSS5_COMBINED_SCP_INT;
    for (int ddrss_int = FIRST_DDRSS_INT; ddrss_int <= LAST_DDRSS_INT; ddrss_int++)
    {
        params.ddrss_num = (ddrss_int - FIRST_DDRSS_INT);
