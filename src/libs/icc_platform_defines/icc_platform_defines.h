...
typedef enum _rmss_d2d_mailbox_msg_command_code {
	...
	RMSS_D2D_MAILBOX_DIE_CONFIG_REQ,
	...
	RMSS_D2D_MAILBOX_MSG_GPIO_CLI_CMD,
...
typedef enum RMSS_SPI_Sync_enum
{
    ...
    RMSS_D2D_DDR_PPR_SYNC_POINT_BEFORE_BUILD_DEFECT_LIST,
    RMSS_D2D_DDR_PPR_SYNC_POINT_READY_FOR_DDRSS_INIT,
    RMSS_D2D_DDR_BDAT_BEGIN_SYNC_POINT,
    RMSS_D2D_DDR_BDAT_CRC_READY_SYNC_POINT,
    RMSS_D2D_DDR_SMBIOS16_DONE_SYNC_POINT,
