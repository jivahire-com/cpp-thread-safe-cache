...
#define IFT_WAIT_FOR_SCP_DIE1_US           (10000)
...
/**
 * @brief Executes the IFT memory test sequence.
 * @param[in] ctx Pointer to the async request context.
 */
void ift_execute_mem_test(void* ctx);
/**
 * @brief Executes the IFT core test sequence.
 * @param[in] ctx Pointer to the async request context.
 */
...
/**
 * @brief Sends the IFT test status to HSP via ICC mailbox.
 * @param[in] hsp_icc_ctx Pointer to the HSP ICC context.
 * @param[in] run_status Status value to send.
 */
...
/**
 * @brief Sends IFT test results to HSP via ICC mailbox.
 * @param[in] hsp_icc_ctx Pointer to the HSP ICC context.
 * @param[in] fail_index Index of the last failed test result.
 */
