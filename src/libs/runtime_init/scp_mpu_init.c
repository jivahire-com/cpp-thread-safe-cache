...
FPFW_INIT_COMPONENT(mpu, FPFW_INIT_NULL_NODE)
{
    ...
    const ARM_MPU_Region_t regions[] = {
        ...
        */
         ...
         * For SCP starting address = 0x0138F490, Size = 192 KB
         * 
         ...
         */
        {
            .RBAR = ARM_MPU_RBAR(4, SCP_TOP_SCP_EXP_ADDRESS + SCP_EXP_TOP_SCF_RAM_ADDRESS), // NOLINT
            .RASR = ARM_MPU_RASR(DISABLE_EXEC,
                                 ARM_MPU_AP_PRIV,
                                 TYPE_EXT_1,
                                 SHAREABLE,
         ...
         */
        {
            .RBAR = ARM_MPU_RBAR(5, SCP_TOP_CORTEX_M7_ADDRESS), // NOLINT
            .RASR = ARM_MPU_RASR(DISABLE_EXEC,
                                 ARM_MPU_AP_PRIV,
                                 TYPE_EXT_0,
                                 NON_SHAREABLE,
