...
PLACED_CODE FPFW_INIT_COMPONENT(sds_svc, FPFW_INIT_DEPENDENCIES("dfwk", "atu_svc", "shared_mem"))
{
...
PLACED_CODE FPFW_INIT_COMPONENT(sds_int, FPFW_INIT_DEPENDENCIES("sds_svc"))
{
