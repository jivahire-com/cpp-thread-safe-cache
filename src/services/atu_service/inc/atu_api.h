...
// Each die has a unique DDR range for variable service, but window location is the same for both dies
// the variable service reserved memory is evenly split between the two dies
// To Do - below define will be removed once https://dev.azure.com/ms-tsd/Base_IP/_workitems/edit/849213/merged
#define MSCP_VAR_SVC_PAYLOADS_RESERVATION_BASE (0x20128004000)
#define MSCP_VAR_SVC_PAYLOADS_RESERVATION_END (0x20128008000) 
///
