...
atu_map_entry_t atu_static_map_die0[] = {
    // ARSM Section : SDS Buffer Only, Rest of ARSM Space for TFA
    {
        .ap_base_address = ALIGN_DOWN(SDS_AP_ADDRESS_BASE, ATU_PAGE_SIZE),
        .mscp_start_address = ATU_AP_ARSM_ADDRESS,
        .mscp_end_address = ALIGN_UP(ATU_AP_ARSM_ADDRESS + SDS_SIZE_MAX, ATU_PAGE_SIZE) - 1,
