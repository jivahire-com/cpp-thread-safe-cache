...
typedef enum
{
    ...
    ETR_EVENT_ID_MCP_ETR_SERVICE_LOG_HSP_ICC_REQ,
    ETR_EVENT_ID_MCP_ETR_SERVICE_LOG_HSP_BUFFER_PROC,
    ETR_EVENT_ID_MCP_ETR_SERVICE_LOG_HOST_READ_REQ,
    ETR_EVENT_ID_MCP_ETR_SERVICE_MAX
} ETR_EVENT_ID_MCP;

/*------------------- Declarations (Statics and globals) --------------------*/

FPFW_ET_DEFINE_PROVIDER_EX(EVENT_TRACE_PROVIDER_ID_MCP_ETR_SERVICE,
                           Etr,
...
FPFW_ET_DEFINE_EVENT(EVENT_TRACE_PROVIDER_ID_MCP_ETR_SERVICE,
                     ...
                     HostReq,
                     FPFW_ET_LEVEL_VERBOSE,
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT64_HEX, PhyAddr),
...
FPFW_ET_DEFINE_EVENT(EVENT_TRACE_PROVIDER_ID_MCP_ETR_SERVICE,
                     ...
                     FPFW_ET_LEVEL_VERBOSE,
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT64_HEX, PhyAddr),
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT32_HEX, AtuAddr)
)
