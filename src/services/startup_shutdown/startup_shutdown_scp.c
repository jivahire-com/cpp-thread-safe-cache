...
static startup_shutdown_boot_stage_t scp_boot_stages[] = {
    ...
    {STARTUP_PHASE_MSCP_ASYNC, STARTUP_MSCP_MANIFEST_LOAD, DEFAULT_SOS_TIMEOUT_MS, false, false},
    {STARTUP_PHASE_MSCP_ASYNC, STARTUP_ACCEL_MANIFEST_LOAD, DEFAULT_SOS_TIMEOUT_MS, false, false},
    ...
    {STARTUP_PHASE_AP_ASYNC, STARTUP_DIE_CONFIG_INIT, DEFAULT_SOS_TIMEOUT_MS, false, true},
    {STARTUP_PHASE_AP_ASYNC, STARTUP_PCIE_LTSSM_INIT, DEFAULT_SOS_TIMEOUT_MS, false, false},
    {STARTUP_PHASE_AP_ASYNC, STARTUP_SYNC_SDM_BOOT_COMPLETE, DEFAULT_SOS_TIMEOUT_MS, false, false},
    {STARTUP_PHASE_AP_ASYNC, STARTUP_SYNC_CDED_BOOT_COMPLETE, DEFAULT_SOS_TIMEOUT_MS, false, false},
    {STARTUP_PHASE_AP_ASYNC, STARTUP_PRIMARY_AP_CORE_BOOT, DEFAULT_SOS_TIMEOUT_MS, false, true},
    {STARTUP_WARM_BOOT_SDM_ASYNC, STARTUP_SDM_ITCM_LOAD, DEFAULT_SOS_TIMEOUT_MS, false, false},
    ...
    // IFT boot flow
    {STARTUP_PHASE_IFT_ASYNC, STARTUP_CLUSTER_CORE_INIT, DEFAULT_SOS_TIMEOUT_MS, false, false},
    {STARTUP_PHASE_IFT_ASYNC, STARTUP_AP_SOC_POWER_INIT, DEFAULT_SOS_TIMEOUT_MS, false, true},
    {STARTUP_PHASE_IFT_MEM_FW_LOAD, STARTUP_IFT_MEM_FW_LOAD, DEFAULT_SOS_TIMEOUT_MS, false, false},
    {STARTUP_PHASE_IFT_CORE_FW_LOAD, STARTUP_IFT_CORE_FW_LOAD, DEFAULT_SOS_TIMEOUT_MS, false, false},
};
