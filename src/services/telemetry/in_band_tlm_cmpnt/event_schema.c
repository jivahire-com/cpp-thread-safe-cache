...
FPFW_ET_DEFINE_PROVIDER_EX(EVENT_TRACE_PROVIDER_ID_MCP_POWER_TLM,
                           TlmSvcPowerEv,
...
FPFW_ET_DEFINE_PROVIDER_EX(EVENT_TRACE_PROVIDER_ID_MCP_PERF_TLM,
                           TlmSvcPerfEv,
                           FPFW_ET_LEVEL_MASK_INFO | FPFW_ET_LEVEL_MASK_WARNING | FPFW_ET_LEVEL_MASK_ERROR |
                               FPFW_ET_LEVEL_MASK_FATAL | FPFW_ET_LEVEL_MASK_ALWAYS);

FPFW_ET_DEFINE_EVENT(EVENT_TRACE_PROVIDER_ID_MCP_POWER_TLM,
                     POWER_TELEMETRY_EVENT_CORE_PSTATE,
                     pwr_core_event_pstate,
                     FPFW_ET_LEVEL_INFO,
...
FPFW_ET_DEFINE_EVENT(EVENT_TRACE_PROVIDER_ID_MCP_POWER_TLM,
                     ...
                     pwr_core_event_rack_priorities,
                     FPFW_ET_LEVEL_INFO,
...
FPFW_ET_DEFINE_EVENT(EVENT_TRACE_PROVIDER_ID_MCP_POWER_TLM,
                     ...
                     pwr_event_mpam_throttle,
                     FPFW_ET_LEVEL_INFO,
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT16, nominal_frequency),
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT16, max_pstate_frequency),
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT16, avg_throttle_frequency),
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT16, throttle_extent),
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT32, throttle_duration_mS))

FPFW_ET_DEFINE_EVENT(EVENT_TRACE_PROVIDER_ID_MCP_PERF_TLM,
                     PERFORMANCE_TELEMETRY_EVENT_CORE,
                     perf_core_event_summary,
                     FPFW_ET_LEVEL_INFO,
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT8, pstate_id),
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT8, cstate_id),
                     ...
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT8, throttle_type_residency),
                     FPFW_ET_DEFINE_FIELD(FPFW_ET_UINT8, throttle_priority_residency),
