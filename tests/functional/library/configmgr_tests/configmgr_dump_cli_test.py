...
- Test that checks for Config Manager CLI Dump Command.
"""
import time
import sys, os
import subprocess
...
class configmgr_dump_cli_test(EchoFallsBaseTest):
    ...
    def __init__(
        self,
        name: str = "Configmgr_cli_test_dump",
        number: str = "NaN",
    ...
    def configmgr_dump_cli_test(self):
        """ 
        Test function: 
            1. Setup the Test. 
