...
try:
    ...
    from .trp_lib import dcs_cli_trp_endpoint
...
class DcsDcpTest(EchoFallsBaseTest):
    ...
    def setup(self) -> bool:
        ...
        try:
            ...
            self.die0_scp_trp_endpoint = dcs_cli_trp_endpoint(self.die0_scp_channel, 0, transfer_relay_protocol.cpu_type.CPU_SCP)
            ...
            dcp_commands.client_reset(
                    ...
                    client_id=data_collection_protocol.dcp_client_id_t.DCP_CLIENT_ID_PWR_INST_TELEM)
    ...
    def test_client_start_stop(self, command=None):
        ...
        try:
            ...
            # test reset turn off the client
            # Exception raised if command fails
            dcp_commands.client_reset(
                    src_endpoint = self.die0_scp_trp_endpoint,
                    dest_die=0,
...
from trp_lib import trp_endpoint, dcs_cli_trp_endpoint
from dcp_protocol import data_collection_protocol
from trp_protocol import transfer_relay_protocol
...
# & (Join-Path ([System.Environment]::GetEnvironmentVariable("REPO_APP_PATH_python.win64", "Process")) "/tools/python.exe") tests/functional/pythia/pylibs/dcs_tests/dcs_dcp_test.py
#

def main():
    print("This is the main entry point of dcs_dcp_test.py")
    ...
    die0_scp_trp_endpoint = dcs_cli_trp_endpoint(telnet_port, 0, transfer_relay_protocol.cpu_type.CPU_SCP)
