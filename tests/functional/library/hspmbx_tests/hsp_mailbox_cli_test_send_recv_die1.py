...
- Test that checks for HSP Mailbox SEND RECV Die1 Command.
"""
import time
import sys, os
...
class hsp_mailbox_cli_test_send_recv_die1(EchoFallsBaseTest):
    ...
    def __init__(
        self,
        name: str = "HSPMBX_Send_Recv_Test_die1",
        number: str = "NaN",
    ...
    def hsp_mailbox_cli_test_send_recv_die1(self):
        """ 
        Test function: 
            1. Setup the Test. 
            ...
            4. Teardown Test. 
        """
        self.log.info("Running HSP Mailbox CLI command Die1 Test. . .")
        self.dut.setup()
