...
- Test the CDED AES-GCM Encrypt/Decrypt functionality from AP (Core 0).
"""
...
class cded_aes_gcm_encr_decr_test(EchoFallsBaseTest):
    ...
    def cded_aes_gcm_encr_decr_test(self, pass_logs, fail_logs):
        """ 
        Test function: 
            1. Setup the Test. 
            2. Wait for AP to be up. Send 'ap_bm cded_test -o ged' command 
            3. Read response and check if test passed or failed based on response
            4. Teardown Test. 
        """
        self.log.info("Running CDED AES-GCM Encrypt/Decrypt test...")
