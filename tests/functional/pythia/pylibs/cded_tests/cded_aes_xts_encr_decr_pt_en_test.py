...
- Test the CDED AES-XTS Encrypt/Decrypt functionality with passthrough enabled from AP (Core 0)
"""
...
class cded_aes_xts_encr_decr_pt_en_test(EchoFallsBaseTest):
    ...
    def cded_aes_xts_encr_decr_pt_en_test(self, pass_logs, fail_logs):
        """ 
        Test function: 
            1. Setup the Test. 
            2. Wait for AP to be up. Send 'ap_bm cded_test -o xed -p' command 
