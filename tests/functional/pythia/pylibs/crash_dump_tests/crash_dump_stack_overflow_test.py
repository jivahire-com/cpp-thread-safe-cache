...
- Tests Crash Dump stack overflow Die0.
"""
import time
import sys, os
...
class crash_dump_stack_overflow_test(EchoFallsBaseTest):
    ...
    def __init__(
        self,
        name: str = "cd_stack_overflow_test",
        number: str = "NaN",
    ...
    def crash_dump_stack_overflow_test(self):
        """
        Crash Dump test:
            1. Setup the Test.
            ...
            3. Teardown Test.
        """
        self.log.info("Running Crash Dump stack overflow tests on Die0  . . .")
        self.dut.setup()
