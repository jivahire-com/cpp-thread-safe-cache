...
class scp_heart_beat(EchoFallsBaseTest):
    ...
    def scp_heartbeat(self):
        ...
        scp_lines = ' '.join(KngPythiaTestIF.read_and_log_lines(self=self, connection=self.dut.mb.node_0.soc.primary_die.scp.channel_manager.get_current_channel(), num_lines=exp_num_lines))
