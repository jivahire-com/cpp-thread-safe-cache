...
- Test that checks for Large FIFO Mailbox SEND RECV Command.
"""
...
class largefifo_mailbox_cli_test_send_recv(EchoFallsBaseTest):
    ...
    def __init__(
        self,
        name: str = "LargeFIFOMBX_SCP_SDM_Send_Recv",
        number: str = "NaN",
    ...
    def largefifo_mailbox_cli_test_send_recv(self):
        """ 
        Test function: 
            1. Setup the Test. 
        ...
        self._submit_command(sdm_channel, "scp_recv 2")
