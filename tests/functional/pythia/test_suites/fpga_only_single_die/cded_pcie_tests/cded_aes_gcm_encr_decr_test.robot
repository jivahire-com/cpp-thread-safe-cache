...
Library     pylibs.cded_tests.cded_aes_gcm_encr_decr_test
...         workspace_config=${WORKSPACE_CONFIG}
...         default_log_home=${LOG_DIR}
...         fw_payload_path=${PAYLOAD_DIR}
...         host_config=${HOST_CONFIG_DIR}/mscp_runtime_fw.json
...         WITH NAME    cded_aes_gcm_encr_decr_test_lib
...
Test Case - AP: CDED PF GCM Encryption-Decryption test with Keys in DDR: [1836729]
    ...
    # Get an instance of the cded_aes_gcm_encr_decr_test library
    ${test_lib} =       Get Library Instance      cded_aes_gcm_encr_decr_test_lib

    # Check for both failure and success strings in the output.
    ${test_result} =        Call Method         ${test_lib}         cded_aes_gcm_encr_decr_test       ${PASS_RESPONSE}        ${FAIL_RESPONSE}
