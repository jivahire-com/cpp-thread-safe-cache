...
Library     pylibs.cded_tests.cded_comp_decomp_pt_en_test
...         workspace_config=${WORKSPACE_CONFIG}
...         default_log_home=${LOG_DIR}
...         fw_payload_path=${PAYLOAD_DIR}
...         host_config=${HOST_CONFIG_DIR}/mscp_runtime_fw.json
...         WITH NAME    cded_comp_decomp_pt_en_test_lib
...
Test Case - AP: CDED PF Compression-Decompression Test with PassThough Enabled: [1836729]
    ...
    # Get an instance of the cded_comp_decomp_pt_en_test library
    ${test_lib} =       Get Library Instance      cded_comp_decomp_pt_en_test_lib

    # Check for both failure and success strings in the output.
    ${test_result} =        Call Method         ${test_lib}         cded_comp_decomp_pt_en_test       ${PASS_RESPONSE}        ${FAIL_RESPONSE}
