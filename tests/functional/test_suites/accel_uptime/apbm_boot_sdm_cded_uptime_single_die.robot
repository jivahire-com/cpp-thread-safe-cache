...
*** Settings ***
Documentation    Die0: Accel (SDM / CDED): Verify Uptime over UART [1140820]

Library          ${LIBRARIES}/test_utility.py
...              name=apbm_boot_sdm_cded_uptime_die0_logs
...
Test Tags        apbm_boot_sdm_cded_uptime_single_die
...
*** Test Cases ***
Test Case - SDM: SDM Full Boot Chain - SDM Uptime Single Die (Die 0): [1140820]
    [Documentation]     Check SDM Uptime Single Die (Die 0)
...
Test Case - CDED: CDED Full Boot Chain - CDED Uptime Single Die (Die 0): [1140820]
    [Documentation]     Check CDED Uptime Single Die (Die 0)
