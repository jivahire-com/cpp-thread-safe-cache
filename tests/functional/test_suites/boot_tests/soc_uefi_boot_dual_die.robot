...
Library     library.boot_tests.soc_uefi_boot_dd
...         workspace_config=${WORKSPACE_CONFIG}
...         default_log_home=${LOG_DIR}
...         fw_payload_path=${PAYLOAD_DIR}
...         host_config=${HOST_CONFIG_DIR}/debugpc-1103e12-n1.json
...         WITH NAME    soc_uefi_boot_dd_test_lib

*** Test Cases ***
Test Case - MSCP: SOC UEFI boot DualDie Test
    # Get an instance of the test library
    ${test_lib} =    Get Library Instance    soc_uefi_boot_dd_test_lib
    
    # Call the test method from the test library and store the result
    ${test_result} =    Call Method    ${test_lib}    soc_uefi_boot_dd
