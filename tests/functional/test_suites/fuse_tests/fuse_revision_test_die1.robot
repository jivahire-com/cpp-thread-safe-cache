...
Library     library.fuse_tests.fuse_revision_test_die1
...         workspace_config=${WORKSPACE_CONFIG}
...         default_log_home=${LOG_DIR}
...         fw_payload_path=${PAYLOAD_DIR}
...         host_config=${HOST_CONFIG_DIR}/hsp_scp_bl_embed_fw_dual_die.json
...         WITH NAME    fuse_revision_test_die1_lib
...
Test Case - Fuse revision Test
    ...
    ${test_lib} =       Get Library Instance      fuse_revision_test_die1_lib

    # Check for both failure and success strings in the output.
    ${test_result} =        Call Method         ${test_lib}         fuse_revision_test_die1
