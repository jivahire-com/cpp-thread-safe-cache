...
*** Settings ***
Documentation    Die0: ICC/MBOX: SVP: Large FIFO Mailbox SEND/RECV command for CDED <-> SCP [2258003].

Library          ${LIBRARIES}/test_utility.py
...              name=scp_cded_mbx_die0_tests_logs
...
*** Test Cases ***
Test Case - ICC Loopback Test CDED Send SCP Receive: [2116490]

    Send Test Command    icc_largembx cded_recv 2    scp0
    ...
    Send Test Command    scp_mbx scp_send 2    sdm_cded0
...
Test Case - ICC Loopback Test SCP Send CDED Receive: [2116490]

    Send Test Command    scp_mbx scp_recv 3    sdm_cded0
    ...
    Send Test Command    icc_largembx cded_send 3    scp0
