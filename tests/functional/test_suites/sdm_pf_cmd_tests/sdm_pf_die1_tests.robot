...
...                                 sdm_memcpy_test-: ****  SDM MEMCPY Test on Die 1 DONE ****
@{E2I_I2E_PASS_RESPONSE}            User Defined Loopback Test on Die 1 End!
@{INV_OPCODE_TEST_PASS_RESPONSE}    User Defined Invalid Opcode Test on Die 1 End!
@{FAIL_RESPONSE}                    FAIL
${TIMEOUT}                          ${80}
...
Test Case - AP: SDM memcpy Test: FR [1423800]
    ...
    Send Test Command    ap_bm sdm_memcpy_test 1    apns0
    ${test_result}    Parse Test Output    apns0    SDM MEMCPY Test on Die 1 DONE     ${SDM_MEMCPY_PASS_RESPONSE}
...
#     Send Test Command    ap_bm user_def_loopback_test 0 0 1    apns0
#     ${test_result}    Parse Test Output    apns0    User Defined Loopback Test on Die 1 End!     ${E2I_I2E_PASS_RESPONSE}
#     ...    ${FAIL_RESPONSE}     ${IGNORE_NUMBERS}    ${TIMEOUT}
#     Should Be True      ${test_result}
...
#     Send Test Command    ap_bm user_def_invalid_opcode_test 0 0 1    apns0
#     ${test_result}    Parse Test Output    apns0     User Defined Invalid Opcode Test on Die 1 End!     ${INV_OPCODE_TEST_PASS_RESPONSE}
#     ...    ${FAIL_RESPONSE}     ${IGNORE_NUMBERS}    ${TIMEOUT}
#     Should Be True      ${test_result}
