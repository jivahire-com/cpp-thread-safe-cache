...
Test Single FIFO Overflow
    [Documentation]    Test overflow functionality for a single FIFO (CURRENT)
    [Tags]    ssi    sensor_fifo    overflow    single_fifo    TEST_CASE_ID:2143635
    ...
    ${FIFO_NAME}=    Set Variable    CURRENT
