...
Test Single FIFO Overflow
    [Documentation]    Test overflow functionality for a single FIFO (PSTATE)
    [Tags]    ssi    sensor_fifo    overflow    single_fifo    TEST_CASE_ID:2143254
    ...
    # Run overflow test and capture result (Can be kept in a keyword and in common resource but for now it is kept here for clarity and better readability and easy debugging)
    TRY
