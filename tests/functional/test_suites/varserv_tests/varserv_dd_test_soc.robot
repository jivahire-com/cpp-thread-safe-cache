...
Test Case - Variable Services CLI SET GET Test
    ...
    ${test_lib} =       Get Library Instance      varserv_dd_test_lib

    # Check for both failure and success strings in the output.
    ${test_result} =        Call Method         ${test_lib}         varserv_dd_test
