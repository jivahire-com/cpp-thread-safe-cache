...
static kingsgate_boot_config_t test_boot_config = {
    ...
    .data_src_end = (size_t)&test_main_data.compressed_dtcm[DTCM_COMPRESSED_STRING_SIZE - 1],
...
TEST_FUNCTION(test_unpack_image_dtcm_decompress_success, nullptr, nullptr)
{
