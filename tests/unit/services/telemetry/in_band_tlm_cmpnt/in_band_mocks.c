...
{
    FPFW_UNUSED(core_id);
    memset( (*pstate_array), 0xFF, sizeof(pwr_core_event_pstate_t) * NUMBER_OF_PSTATES);
...
{
    FPFW_UNUSED(core_id);
    memset( (*cstate_array), 0xFF, sizeof(pwr_core_event_cstate_t) * NUMBER_OF_CSTATES);

    function_called();
}

void data_proc_tlm_cmpnt_get_pwr_core_throttle_data(uint16_t core_id,
                                                    pwr_core_event_throttle_t (*throttle_array)[NUMBER_OF_THROTTLE_TYPES])
{
    FPFW_UNUSED(core_id);
    memset( (*throttle_array), 0xFF, sizeof(pwr_core_event_throttle_t) * NUMBER_OF_THROTTLE_TYPES);

    function_called();
}

void data_proc_tlm_cmpnt_get_pwr_core_rack_priority_data(uint16_t core_id,
                                                         pwr_core_event_rack_priorities_t (*rack_priority_array)[NUMBER_OF_RACK_PRIORITIES])
{
    FPFW_UNUSED(core_id);
    memset( (*rack_priority_array), 0xFF, sizeof(pwr_core_event_rack_priorities_t) * NUMBER_OF_RACK_PRIORITIES);
...
{
    FPFW_UNUSED(core_id);
    memset( voltage_data, 0xFF, sizeof(pwr_core_event_voltage_t));
...
{
    FPFW_UNUSED(core_id);
    memset( current_data, 0xFF, sizeof(pwr_core_event_current_t));
...
{
    FPFW_UNUSED(core_id);
    memset( temperature_data, 0xFF, sizeof(pwr_core_event_temperature_t));
...
void data_proc_tlm_cmpnt_get_pwr_core_histogram_data(
    uint16_t core_id,
    pwr_core_event_histogram_t (*histogram_array)[NUMBER_OF_HS_VOLTAGE_SCALES][NUMBER_OF_HS_TEMP_SCALES])
{
    FPFW_UNUSED(core_id);
    memset( (*histogram_array), 0xFF, sizeof(pwr_core_event_histogram_t) * NUMBER_OF_HS_VOLTAGE_SCALES * NUMBER_OF_HS_TEMP_SCALES);
...
{
    memset( soc_pc3_data, 0xFF, sizeof(pwr_soc_event_pc3_t));
...
{
    FPFW_UNUSED(rail_id);
    memset( rail_data, 0xFF, sizeof(pwr_soc_event_vr_rail_t));
...
void data_proc_tlm_cmpnt_get_pwr_soc_hnf_data(uint16_t hnf_channel, p_pwr_soc_event_hnf_t hnf_data)
{
    ...
    memset( hnf_data, 0xFF, sizeof(pwr_soc_event_hnf_t));
...
void data_proc_tlm_cmpnt_get_pwr_soc_dimm_data(uint16_t dimm_channel, p_pwr_soc_event_dimm_t dimm_data)
{
    ...
    memset( dimm_data, 0xFF, sizeof(pwr_soc_event_dimm_t));
...
void data_proc_tlm_cmpnt_get_pwr_soc_snsr_temp_data(uint16_t sensor_id, p_pwr_soc_event_sensor_temp_t sensor_temp_data)
{
    ...
    memset( sensor_temp_data, 0xFF, sizeof(pwr_soc_event_sensor_temp_t));

    function_called();
}

void data_proc_tlm_cmpnt_get_pwr_mpam_pstate_data(uint16_t mpam_id,
                                                  pwr_event_mpam_pstate_t (*mpam_pstate_array)[NUMBER_OF_PSTATES])
{
    FPFW_UNUSED(mpam_id);
    memset( (*mpam_pstate_array), 0xFF, sizeof(pwr_event_mpam_pstate_t) * NUMBER_OF_PSTATES);
...
{
    FPFW_UNUSED(mpam_id);
    memset(mpam_throttle_data, 0xFF, sizeof(pwr_event_mpam_throttle_t));
...
{
    FPFW_UNUSED(core_id);
    memset( core_summary_data, 0xFF, sizeof(perf_core_event_summary_t));
...
{
    FPFW_UNUSED(rail_id);
    memset( rail_data, 0xFF, sizeof(perf_soc_event_rail_t));
...
void data_proc_tlm_cmpnt_get_perf_soc_dimm_runtime_data(uint16_t dimm_module, p_perf_soc_event_dimm_runtime_t dimm_data)
{
    ...
    memset( dimm_data, 0xFF, sizeof(perf_soc_event_dimm_runtime_t));
...
{
    memset(dimm_cfg, 0xFF, sizeof(perf_soc_event_dimm_config_t));
...
{
    FPFW_UNUSED(sensor_id);
    memset(sensor_temp_data, 0xFF, sizeof(perf_soc_event_sensor_temp_t));
...
{
    FPFW_UNUSED(core_id);
    memset(amu_data, 0xFF, sizeof(perf_core_event_amu_counters_t) );
